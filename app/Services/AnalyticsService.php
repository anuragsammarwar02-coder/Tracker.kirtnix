...
class AnalyticsService
{
    ...
    public function getMetricsSummary(array $filters = []): array
    {
        ...
        $joins = (clone $eventsQuery)->whereIn('event_type', ['join', 'join_request'])->distinct('telegram_user_id')->count('telegram_user_id') ?: (clone $eventsQuery)->whereIn('event_type', ['join', 'join_request'])->count();
