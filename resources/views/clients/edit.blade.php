    ...
    <form method="POST" action="{{ route('clients.update', $client) }}" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
          <label class="form-label" style="margin-bottom: 0;">Meta Ad Account</label>
        ...
        @include('clients._ad_account_picker', [
          ...
          'selectedId' => old('ad_account_id', $client->ad_account_id),
        ...
        @else
          <div class="form-hint" style="margin-top: 6px;">Change or reassign the Meta Ad Account used to fetch marketing spend, reach, and conversion metrics.</div>
        @endif
      </div>
