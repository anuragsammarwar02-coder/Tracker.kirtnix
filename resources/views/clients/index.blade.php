  ...
  <div x-show="createModal" style="display: none;" class="modal-backdrop" @click.self="createModal = false">
    <div class="modal-content" style="max-width: 540px; padding: 24px;">
      ...
      <form method="POST" action="{{ route('clients.store') }}">
        ...
        <!-- Meta Ad Account Selection Dropdown with Search & Quick Fetch -->
        <div class="form-group" style="margin-bottom: 14px;">
          ...
          @include('clients._ad_account_picker', [
            ...
            'selectedId' => '',
            'selectId' => 'modal_create_ad_account_id',
            'selectName' => 'ad_account_id',
            'hasGlobalMetaConnection' => $hasGlobalMetaConnection
          ])

          @if(!$hasGlobalMetaConnection)
            <div class="form-hint" style="color: #b45309; font-size: 11px; margin-top: 6px;">⚠️ Global Meta not connected. Connect in <a href="{{ route('settings.index', ['tab' => 'meta']) }}" style="color: var(--accent-blue);">Settings ➔ Meta</a>.</div>
          @else
            <div class="form-hint" style="font-size: 11px; margin-top: 6px;">Marketing data will automatically sync from this specific Meta Ad Account.</div>
          @endif
        </div>
