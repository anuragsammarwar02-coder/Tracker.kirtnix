...
Route::get('/internal/recover-production-records', function () {
    try {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Real production clients, landing pages, and telegram channels recovered successfully into persistent database.',
            'clients_count' => \App\Models\Client::count(),
            'landing_pages_count' => \App\Models\LandingPage::count(),
            'channels_count' => \App\Models\TelegramChannel::count(),
            'bots_count' => \App\Models\TelegramBot::count(),
            'meta_connections_count' => \App\Models\MetaConnection::count(),
        ]);
    } catch (\Throwable $e) {
