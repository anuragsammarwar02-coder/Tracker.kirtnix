...
(function(window, document) {
  ...
  function handleCtaClick(e, el) {
    ...
    if (typeof window.fbq === 'function') {
      try {
        // Track CTA Click as funnel event (TelegramClick & Lead for optimization) - NEVER Subscribe (Subscribe is strictly for confirmed Telegram joins/requests via Bot CAPI)
