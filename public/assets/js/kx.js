...
(function(window, document) {
  ...
  function trackPageView(callback) {
    ...
    var payload = {
      ...
      utm_source: urlParams.utm_source || (urlParams.fbclid ? 'meta' : 'direct'),
      utm_medium: urlParams.utm_medium || (urlParams.fbclid ? 'cpc' : ''),
      utm_campaign: urlParams.utm_campaign || urlParams.campaign_name || urlParams.campaign || urlParams.cname || urlParams.utm_id || urlParams.campaign_id || '',
      campaign_id: urlParams.campaign_id || urlParams.utm_id || urlParams.hsa_cam || '',
      utm_content: urlParams.utm_content || urlParams.ad_name || urlParams.ad_id || '',
      utm_term: urlParams.utm_term || urlParams.adset_name || urlParams.adset_id || '',
